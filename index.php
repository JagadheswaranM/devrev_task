...
background: -webkit-linear-gradient(to right, #738bc7, #4d7df7);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #738bc7, #4d7df7); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
background-image:url("https://images.pexels.com/photos/2835436/pexels-photo-2835436.jpeg?auto=compress&cs=tinysrgb&w=600");
...
@font-face {
  ...
  src: url('assets/css/Open sans Bold.ttf');
}
h1{
	...
	<div class="main-agileinfo">
		...
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list" style="border-radius: 10px; background: linear-gradient(to right, #738bc7, #4d7df7);">
					<!-- <li class="resp-tab-item"><span>Round Trip</span></li> -->
					<li class="resp-tab-item" style="color: black; font-size:20px; font-weight: bold;"><span>One way</span></li>
				</ul>	
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<footer class="mt-5">
	<em><h5 style="background-color: grey; color: white;" class="text-light text-center p-0 brand mt-2">
    <img src="assets/images/images.png" height="40px" width="40px" alt=""> Flight Zone<br>&copy; <?php echo date('Y')?> - Jagadheswaran M<br>
</h5>
</em>
	<!-- <p>----------</p> -->
