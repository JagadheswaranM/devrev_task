  ...
  color: #424242;
    ...
    <main>
        <?php if(isset($_POST['search_but'])) { 
            ...
            // echo "<script type='text/javascript'>alert('$dep_date');</script>"; 
            $type = $_POST['type'];
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $t=$date->format("H:i:s");
                  // echo "<script type='text/javascript'>alert('$row[departure]');</script>"; 
                 // echo "<script type='text/javascript'>alert('$t');</script>"; 
                  ...
                  <tr class='text-center'>                  
                    ...
                    <td>Rs.".$price."</td>
                    ";
                  if(isset($_SESSION['userId']) && $status != "Departed") {   
                    echo " <td>
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			Flight Zone</h5></em>
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Jagadheswaran M</p>
</footer>